...
class RestaurantAnalyzer {
    ...
    private int[] ratingRanges;

    public RestaurantAnalyzer(List<Restaurant> restaurants, int[] ratingRanges) {
...
public class RestaurantRatingAnalyzer {
    public static void main(String[] args) {
        ...
        RestaurantAnalyzer analyzer = new RestaurantAnalyzer(restaurants, ratingRanges);
